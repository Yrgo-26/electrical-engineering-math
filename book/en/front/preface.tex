...
\begin{itemize}
  ...
  \item Powers, roots, binary and hexadecimal numbers, quadratic equations, and exponential
    functions and logarithms, including decibels.
...
\begin{booktable}{@{}p{5em}L@{}}
  ...
  \midrule
  1 & Number sets and basic arithmetic \\
  2 & Algebra \\
  3 & Linear equations and inequalities \\
  4 & Systems of equations \\
  5 & Powers, roots and number systems \\
