...
\begin{itemize}
  ...
  \item Potenser, rötter, binära och hexadecimala tal, andragradsekvationer samt
    exponentialfunktioner och logaritmer, inklusive decibel.
...
\begin{booktable}{@{}p{5em}L@{}}
  ...
  \midrule
  1 & Talmängder och grundläggande aritmetik \\
  2 & Algebra \\
  3 & Linjära ekvationer och olikheter \\
  4 & Ekvationssystem \\
  5 & Potenser, rötter och talsystem \\
