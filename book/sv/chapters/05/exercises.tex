% Section 5.10, from lectures/L05/appendix/b_exercises.md.
...
\uppgift{2.4}{Från binärt och hexadecimalt till decimalt}
...
\uppgift{2.5}{Från decimalt till binärt och hexadecimalt}
\begin{parts}
  \item Omvandla $22$ till binär form.
  \item Omvandla $100$ till binär form.
  \item Skriv binärtalet från b) hexadecimalt genom att dela in bitarna i grupper om fyra.
  \item Skriv \code{0x5A} i binär form.
\end{parts}
...
\uppgift{3.15}{Binära tal}
Omvandla binärtalen i a)--c) till decimal form och decimaltalen i d)--f) till binär form.
\begin{delar}(3)
  \task $111_2$
  \task $10000_2$
  \task $101010_2$
...
\uppgift{3.16}{Hexadecimala tal}
Omvandla talen i a)--c) till decimal form och talen i d)--f) till hexadecimal form.
\begin{delar}(3)
  \task $\mathrm{1F}_{16}$
  \task \code{0x80}
  \task $\mathrm{ABC}_{16}$
...
\uppgift{3.17}{Mellan binärt och hexadecimalt}
Skriv binärtalen i a)--c) hexadecimalt och de hexadecimala talen i d)--f) binärt.
\begin{delar}(3)
  \task $1001\,1110_2$
  \task $1111\,0000_2$
  \task $101011_2$
...
\uppgift{3.18}{Bitar, byte och register}
Bitarna i ett binärtal numreras från höger med början på $0$.
\begin{parts}
  \item Hur många olika värden kan lagras med $4$ bitar? Vilket är det största värdet?
  \item En AD-omvandlare (analog-digitalomvandlare) med $10$ bitars upplösning omvandlar en
    spänning till ett heltal. Hur många olika värden kan den ge, och vilket är det största?
  \item Ett 8-bitars register har värdet \code{0x24}. Vilka bitar är ettor?
  \item I ett 8-bitars register ska bit~$0$ och bit~$7$ vara ettor och övriga bitar nollor. Ange
    registrets värde binärt, hexadecimalt och decimalt.
\end{parts}
