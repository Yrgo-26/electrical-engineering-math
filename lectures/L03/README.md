# L03 – Linjära ekvationer och olikheter

## Dagordning
* Lösa linjära ekvationer.
* Lösa olikheter och rita lösningsintervall på tallinjen.
* Absolutbelopp.
...
### Innan lektionen
* Läs igenom materialet i [bilaga A](./appendix/a_theory.md) eller kapitel 3 i boken ([svenska](../../book/elteknisk-matematik.pdf) eller [engelska](../../book/electrical-engineering-mathematics.pdf)).
...
## Nästa lektion
* Ekvationssystem – substitutionsmetoden och additionsmetoden.
