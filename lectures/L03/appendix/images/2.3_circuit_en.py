"""Draw 2.3_circuit_en.png: the voltage divider of 2.3_circuit.png, with English labels.

Usage: python3 2.3_circuit_en.py (requires matplotlib and schemdraw). The image is written next
to this script. The drawing matches 2.3_circuit.png, which has no script of its own, to within a
few pixels; draw() takes the labels, so the Swedish ones (U_ut) give that figure back. The same
figure is 1.3_circuit.png in L02, drawn by a copy of this script.
"""
