...
Antag $U_{\text{in}} = 9\,\text{V}$, $R_2 = 3\,\Omega$ och $U_{\text{ut}} = 3\,\text{V}$.
...
Kondensatorns kapacitans är $C = 100\,\mu\text{F} = 100 \times 10^{-6}\,\text{F}$ och tidskonstanten $\tau = 0{,}05\,\text{s}$.
...
**a)** Beräkna klämspänningen $U$ då $I = 2\,\text{A}$.

**b)** Den anslutna enheten kräver minst $9\,\text{V}$ för att fungera. Sätt upp olikheten $U \geq 9$ och lös den för $I$.

> **Tips:** Tänk på vad som händer med olikhetstecknet när du dividerar med ett negativt tal.

**c)** Ett annat batteri har $E = 13\,\text{V}$ och $R_i = 1{,}0\,\Omega$. Vid vilken ström ger de båda batterierna samma klämspänning? Ställ upp en ekvation med obekant i båda led och lös den.

**d)** Vilket av batterierna ger högst klämspänning vid $I = 8\,\text{A}$?

---

### 2.7 – Absolutbelopp i signalanalys
En signal kan ha positiv eller negativ avvikelse från en referensspänning. Avvikelsen $\delta$ uppfyller $|\delta| \leq 0{,}5\,\text{V}$.

**a)** Skriv om absolutbeloppsolikheten som ett dubbelsidat intervall utan absolutbelopp.

**b)** Om referensspänningen är $5\,\text{V}$, ange det tillåtna intervallet för den faktiska spänningen.
...
**b)** Regulatorn larmar när felspänningen har beloppet $1{,}2\,\text{V}$. Lös ekvationen $|0{,}4I - 2| = 1{,}2$ som två fall och ange de två strömmar där larmet triggar.
