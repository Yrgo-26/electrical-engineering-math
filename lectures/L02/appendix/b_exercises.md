...
En transformator med verkningsgraden $\eta = 92\,\%$ tar in $P_{\text{in}} = 500\,\text{W}$.
...
Beräkna spänningsdelaren $U_{\text{ut}}$ för nedanstående formel då $U_{\text{in}} = 12\,\text{V}$, $R_1 = 8\,\Omega$ och $R_2 = 4\,\Omega$:
...
**b)** Beräkna $U_R$ med den ursprungliga formen då $R = 100\,\Omega$, $I_1 = 20\,\text{mA}$, $I_2 = 30\,\text{mA}$ och $I_3 = 50\,\text{mA}$.\
...
**d)** Hur stort blir felet om man struntar i termen $R\,\Delta I^2$? Ange felet i procent av $\Delta P$.
...
**c)** Ett motstånd $R = 6\,\Omega$ matas med $U = 12\,\text{V}$. Beräkna effekten med alla tre formerna $P = UI$, $P = I^2R$ och $P = \dfrac{U^2}{R}$ och kontrollera att de ger samma svar.
